...
@property (nonatomic , copy) void(^addPicturesViewClickBlock)(int viewHeight);

/** 上传成功完成 */
@property (nonatomic, copy) void(^YNImageUploadViewl_FinishBlock)(NSArray *models);
@property (nonatomic, copy) void(^YNImageUploadViewl_delBlock)(void);
