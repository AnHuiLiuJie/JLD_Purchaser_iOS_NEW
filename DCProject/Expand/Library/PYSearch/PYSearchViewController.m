...
- (UITableView *)baseSearchTableView
{
    if (!_baseSearchTableView) {
        UITableView *baseSearchTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, kNavBarHeight, kScreenW, kScreenH - kNavBarHeight) style:UITableViewStyleGrouped];
...
- (void)setSearchSuggestions:(NSArray<NSString *> *_Nullable)searchSuggestions
{
...
- (void)setRankTagBackgroundColorHexStrings:(NSArray<NSString *> *_Nullable)rankTagBackgroundColorHexStrings
{
