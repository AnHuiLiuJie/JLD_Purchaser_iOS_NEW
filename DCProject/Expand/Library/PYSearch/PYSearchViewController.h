 ...
 */
@property (nonatomic, strong) NSArray<NSString *> *_Nullable rankTagBackgroundColorHexStrings;
 ...
 */
@property (nonatomic, copy) NSArray<NSString *> *_Nullable hotSearches;
 ...
 */
@property (nonatomic, copy) NSArray<NSString *> *_Nullable searchSuggestions;
