...
- (void)_setupEvaluateBubbleConstraints {
    ...
    [self.evaluateButton mas_updateConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerY.equalTo(self.backgroundImageView.mas_centerY).offset(10);
    }];
}
...
- (void)setupEvaluateBubbleView {
    ...
    self.evaluateButton.backgroundColor = [UIColor colorWithRed:66.0/255.0 green:229.0/255.0 blue:166.0/255.0 alpha:1.0];
