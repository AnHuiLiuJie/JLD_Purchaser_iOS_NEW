...
//    _backgroundImageView.image = [[UIImage imageNamed:@"HelpDeskUIResource/messageToolbarBg"] stretchableImageWithLeftCapWidth:0.5 topCapHeight:10];
    ...
    //input textview
    _inputTextView = [[HDTextView alloc] initWithFrame:CGRectMake(self.horizontalPadding, self.verticalPadding, self.frame.size.width - self.verticalPadding *2, self.frame.size.height - self.verticalPadding *2)];
//    _inputTextView.autoresizingMask = UIViewAutoresizingFlexibleHeight;
    ...
    _inputTextView.backgroundColor = [UIColor colorWithRed:245 / 255.0 green:247 / 255.0 blue:247 / 247 alpha:1.0];
    ...
    [styleChangeButton setImage:[UIImage imageNamed:@"hd_chatting_setmode_voice_btn_normal"] forState:UIControlStateNormal];
    ...
    [self.faceButton setImage:[UIImage imageNamed:@"hd_chatting_biaoqing_btn_normal"] forState:UIControlStateNormal];
    ...
    [self.moreButton setImage:[UIImage imageNamed:@"hd_type_select_btn_nor"] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:@"hd_type_less_btn_nor"] forState:UIControlStateSelected];
...
- (void)_willShowKeyboardFromFrame:(CGRect)beginFrame toFrame:(CGRect)toFrame
{
    ...
    {
        [self _willShowBottomHeight:toFrame.size.height-LJ_TabbarSafeBottomMargin];
        if (self.activityButtomView) {
            [self.activityButtomView removeFromSuperview];
        }
