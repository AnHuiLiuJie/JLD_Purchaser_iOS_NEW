...
- (void)layoutSubviews
{
    ...
    [self setSendBubbleBackgroundImage:[[UIImage imageNamed:@"HelpDeskUIResource.bundle/chat_sender_bg"] stretchableImageWithLeftCapWidth:5 topCapHeight:35]];
    _bubbleView.articleView.backgroundColor = [UIColor redColor];
    _bubbleView.backgroundImageView.image = self.model.isSender ? self.sendBubbleBackgroundImage : self.recvBubbleBackgroundImage;
    HDExtMsgType type = [HDMessageHelper getMessageExtType:self.model.message];
    switch (type) {
        ...
        case HDExtTrackMsg: {
            [self setSendBubbleBackgroundImage:[[UIImage imageNamed:@"HelpDeskUIResource.bundle/chat_sender_bg2"] stretchableImageWithLeftCapWidth:5 topCapHeight:35]];
            _bubbleView.backgroundImageView.image = self.model.isSender ? self.sendBubbleBackgroundImage : self.recvBubbleBackgroundImage;
            break;
        }
        case HDExtOrderMsg: {
...
//                    }
//                    
//                    CGFloat margin = [HDMessageCell appearance].leftBubbleMargin.left + [HDMessageCell appearance].leftBubbleMargin.right+70;
//                    
