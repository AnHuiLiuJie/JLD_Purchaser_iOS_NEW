...
- (void)layoutSubviews {
    CGSize size = CGSizeMake(self.fl_width - 2 *kLeftMargin, MAXFLOAT);
    _titleLabel.frame = CGRectMake(kLeftMargin, kTopMargin, self.fl_width - 2 *kLeftMargin, kTitleFontSize);
    _timeLabel.frame = CGRectMake(kLeftMargin, CGRectGetMaxY(_titleLabel.frame)+kTopMargin, 200,kDigistFontSize);
    _imageView.frame = CGRectMake(kLeftMargin, CGRectGetMaxY(_timeLabel.frame)+kTopMargin, self.fl_width - 2 *kLeftMargin, kTitleImageHeight);
    ...
    _profile.frame = CGRectMake(kLeftMargin, CGRectGetMaxY(_imageView.frame) + kTopMargin, self.fl_width - 2 *kLeftMargin, imgRect.size.height+kTopMargin);
}
...
- (void)layoutSubviews {
    CGFloat wh = self.fl_height - 20;
    if (_model.type == HDCellTypeTitle) {
        _titleLabel.frame = CGRectMake(10, self.fl_height - kTopMargin - 20, self.fl_width - 20, 15);
        _imageView.frame = CGRectMake(10, 10, self.fl_width - 2 *kLeftMargin, self.fl_height - 2 *kTopMargin);
    }
    if (_model.type == HDCellTypeSub) {
        CGSize size = CGSizeMake(self.fl_width - 20 - wh - 10, MAXFLOAT);
        ...
        _titleLabel.frame = CGRectMake(kLeftMargin, kTopMargin, self.fl_width - 20 - wh - 10, height);
        _imageView.frame = CGRectMake(self.fl_width - wh - 10, 10, wh, wh);
    }
}
