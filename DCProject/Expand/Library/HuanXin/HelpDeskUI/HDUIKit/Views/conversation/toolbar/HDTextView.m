...
- (void)setPlaceHolder:(NSString *)placeHolder {
    ...
    NSUInteger maxChars = [HDTextView maxCharactersPerLine];
...
{
    return [HDTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [HDTextView maxCharactersPerLine]) + 1;
}
...
- (void)setup {
    ...
    self.textContainerInset = UIEdgeInsetsMake(15, 0, 0, 0);
