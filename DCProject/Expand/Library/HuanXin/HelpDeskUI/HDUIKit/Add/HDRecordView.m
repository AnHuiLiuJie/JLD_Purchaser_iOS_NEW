...
#define PinRecord @"长按录音"//NSLocalizedString(@"message.toolBar.record.touch", @"hold down to talk")
...
- (void)setupSubviews
{
    ...
    _recordButton.fl_centerX = _recordLabel.fl_centerX;
    [_recordButton setImage:[UIImage imageNamed:@"hd_record_menu_mic_gray"] forState:UIControlStateNormal];
    [_recordButton setImage:[UIImage imageNamed:@"hd_record_menu_mic_recording"] forState:UIControlStateHighlighted];
...
{
    [self setButtonImage:@"hd_record_menu_mic_gray" andLabelText:PinRecord];
...
{
    [self setButtonImage:@"hd_record_menu_mic_cancel" andLabelText:CancelRecord];
...
{
    [self setButtonImage:@"hd_record_menu_mic_gray" andLabelText:EndOrSlide];
...
- (void)ListenTime
{
    ...
    [self setButtonImage:@"hd_record_menu_too_short" andLabelText:TimeIsTooShort];
