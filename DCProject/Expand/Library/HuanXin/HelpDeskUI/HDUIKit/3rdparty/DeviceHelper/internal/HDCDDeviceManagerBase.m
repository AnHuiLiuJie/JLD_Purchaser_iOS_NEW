...
#import "HDCDDeviceManagerBase.h"
#import "HDCDDeviceManager+ProximitySensor.h"

static HDCDDeviceManager *emCDDeviceManager;
@interface HDCDDeviceManager (){

}

@end

@implementation HDCDDeviceManager
+(HDCDDeviceManager *)sharedInstance{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        emCDDeviceManager = [[HDCDDeviceManager alloc] init];
    });
