...
- (void)mailComposeController:(MFMailComposeViewController*)controller didFinishWithResult:(MFMailComposeResult)result error:(NSError*)error {
    if (result == MFMailComposeResultFailed) {
        UIAlertController *alter = [UIAlertController alertControllerWithTitle:NSEaseLocalizedString(@"Email", nil) message:NSEaseLocalizedString(@"Email failed to send. Please try again.", nil) preferredStyle:UIAlertControllerStyleAlert];
        [alter addAction:[UIAlertAction actionWithTitle:NSEaseLocalizedString(@"Dismiss", nil) style:UIAlertActionStyleDefault handler:nil]];
