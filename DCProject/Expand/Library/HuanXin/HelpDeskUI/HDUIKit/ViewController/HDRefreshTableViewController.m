...
- (void)viewDidLoad {
    ...
    if (@available(iOS 11.0, *)) {
        self.additionalSafeAreaInsets = UIEdgeInsetsMake(0, 0, LJ_TabbarSafeBottomMargin, 0);
    }
    
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height-LJ_TabbarSafeBottomMargin) style:self.style];
