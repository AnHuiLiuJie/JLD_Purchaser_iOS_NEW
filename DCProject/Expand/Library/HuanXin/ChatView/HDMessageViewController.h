...
//点击订单 或者商品
- (void)messageViewController:(HDMessageViewController *)viewController goodsMessageCellSelected:(id<HDIMessageModel>)model;
...
@interface HDMessageViewController : HDRefreshTableViewController<UINavigationControllerDelegate, UIImagePickerControllerDelegate, HDCDDeviceManagerDelegate, HDChatToolbarDelegate, HDChatBarMoreViewDelegate, EMLocationViewDelegate, HDMessageCellDelegate, DCSatisfactionViewDelegate, HDRecordViewDelegate>
