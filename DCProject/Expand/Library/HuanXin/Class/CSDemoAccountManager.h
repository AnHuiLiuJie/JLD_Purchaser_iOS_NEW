...
// 登录账号管理，此数据应该由您服务器返回
@interface CSDemoAccountManager : NSObject<EMClientDelegate>
...
#pragma mark lj_after_add
//环信登录
- (BOOL)login;
@property (nonatomic, strong) GLPTabBarController *homeVC;
@property (nonatomic, strong) DCTabbarController *homeVC1;
@property (nonatomic, weak) HConversationsViewController *conversationListVC;
