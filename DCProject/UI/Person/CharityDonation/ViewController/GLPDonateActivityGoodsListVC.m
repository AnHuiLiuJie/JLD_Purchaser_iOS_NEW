//
//  GLPDonateActivityGoodsListVC.m
//  DCProject
//
//  Created by LiuMac on 2021/7/28.
//

#import "GLPDonateActivityGoodsListVC.h"
// Controllers
// Models
// Views
#import "CaptchaView.h"
/* cell */
#import "DonateActivityGoodsListCell.h"
/* head */
/* foot */
// Vendors
// Categories
...
@interface GLPDonateActivityGoodsListVC ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) NSMutableArray *dataArray;
@end

static NSString *const DonateActivityGoodsListCellID = @"DonateActivityGoodsListCell";

@implementation GLPDonateActivityGoodsListVC
...
- (UITableView *)tableView{
    if (!_tableView) {
        ...
        [_tableView registerNib:[UINib nibWithNibName:NSStringFromClass([DonateActivityGoodsListCell class]) bundle:nil] forCellReuseIdentifier:DonateActivityGoodsListCellID];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
 ...
 - (void)goToLogin{
     ...
     WKLoginVC *vc = [[WKLoginVC alloc] initWithNibName:@"WKLoginVC" bundle:nil];
     vc.view.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:.8f];//弹出的视图背景颜色
     vc.modalPresentationStyle = UIModalPresentationOverCurrentContext;//核心语句
