//
//  GLPDonateGoodsDetailsVC.m
//  DCProject
//
//  Created by LiuMac on 2021/7/29.
//

#import "GLPDonateGoodsDetailsVC.h"
...
@interface GLPDonateGoodsDetailsVC ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) NSMutableArray *dataArray;
@end

@implementation GLPDonateGoodsDetailsVC
