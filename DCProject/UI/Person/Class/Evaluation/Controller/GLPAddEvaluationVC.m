...
@interface GLPAddEvaluationVC ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation GLPAddEvaluationVC

#pragma mark - 请求
- (void)requestLoadData:(NSInteger )type{
    
    if (type == 1) {
        [[DCAPIManager shareManager] glpRequest_b2c_account_eval_orderEvalWithOrderNo:@"" success:^(id  _Nullable response) {
