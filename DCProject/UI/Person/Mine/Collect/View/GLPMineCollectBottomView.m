...
@interface GLPMineCollectBottomView ()

@property (nonatomic, strong) UIButton *removeBtn;

@end

@implementation GLPMineCollectBottomView
...
- (void)setUpUI
{
    ...
    _removeBtn.backgroundColor = [UIColor dc_colorWithHexString:@"#F55810"];
