...
@interface GLPMoreGridView ()<UIGestureRecognizerDelegate>

@end

@implementation GLPMoreGridView
...
- (void)setUpUI
{
    ...
    _gridLabel.font = [UIFont fontWithName:PFR size:12];;
    _gridLabel.textColor = RGB_COLOR(36, 36, 36);
