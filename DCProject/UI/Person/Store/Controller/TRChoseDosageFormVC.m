...
@interface TRChoseDosageFormVC()<UITableViewDelegate,UITableViewDataSource>
...
@implementation TRChoseDosageFormVC
...
//      [self dismissViewControllerAnimated:YES completion:nil];
    ...
    if (self.dosageFormblock) {
        self.dosageFormblock(self.selectArray);
    }
