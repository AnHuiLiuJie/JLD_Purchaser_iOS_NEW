...
//    if (!self.showTopLine) {//lj_change_add
//        UIView *linex = [[UIView alloc] init];
//        linex.backgroundColor = [UIColor colorWithRed:233/255.0f green:233/255.0f blue:233/255.0f alpha:0.3];
//        linex.frame = CGRectMake(0, 0, self.bounds.size.width, 1);
